    ...
    return (
        ...
        <Box style={{ backgroundColor: 'rgb(0, 0, 0, 0.7)' }} component="form" id="editMyServiceform" name="editMyServiceform" onSubmit={updateServiceSubmit} sx={{ '& .MuiTextField-root': { m: 1, width: '35ch' }, }} noValidate autoComplete="off" >
            ...
            <div class="editpopup" style={{ width: '45%', height: '60%', overflowY: 'scroll' }}>
                ...
                <TextField required id="services" type="text" name="services" label="Service"  value={serviceidvar} > </TextField>

                <TextField required id="hourlyrate" type="text" label="Hourly Rate" name="hourlyrate"  defaultValue={hourlyratevar} /> <br />

                <TextField required id="experience" type="text" label="Experience" name="Experience" multiline rows={4} maxRows={6} defaultValue={experiencevar} /> <br />
